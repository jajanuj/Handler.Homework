...
{
    public partial class ucDefineAxisName : ucBaseUserControl
    {
        #region //=====================  區域變數設置 =====================
        ...
        static private ucDefineAxisName m_Singleton;
        /// <summary> 取得唯一物件，避免重覆設置  </summary>
        static public ucDefineAxisName GetSingleton()
        {
            if (m_Singleton == null)
            {
                m_Singleton = new ucDefineAxisName();
            }
            return m_Singleton;
        }

        /// <summary> 建構式 </summary>
        public ucDefineAxisName()
        {
            InitializeComponent();
