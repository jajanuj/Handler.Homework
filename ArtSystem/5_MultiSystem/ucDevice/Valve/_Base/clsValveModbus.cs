...
namespace ArtSystem.Files
{
    ...
    public class clsValveModbus
    {
        ...
        /// <summary> ComPort 的站號 </summary>
        protected string m_sCOM = "COM3";
        /// <summary> ComPort 超時設定 </summary>
        protected int m_iReadWriteTimeout = 300;
        public int g_iStationID
        {
            get
            {
                return iStationID;
        ...
        public bool ComPort_Open(string p_ComPort, int p_StationID, bool p_SimulatorMode, int p_ReadWriteTimeout = 300)
        {
            ...
            m_iReadWriteTimeout = p_ReadWriteTimeout;
        ...
        public bool ComPort_Open()
        {
            ...
            {
                ComPort_Close();
                rValue = ComPort_Open(m_sCOM, iStationID, bIsSimulatorMode, m_iReadWriteTimeout);
            }
            catch (Exception ex)
            {
                clsArtSystem.CatchLog(ex);
