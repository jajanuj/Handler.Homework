...
{
    public class Proc_OK_Discharge_Magazine : BaseMagazine
    {
        #region Constructors

        #region ===================== 建構子 =====================

        public Proc_OK_Discharge_Magazine(string p_strName) : base(p_strName)
        {
            BindHardwarePoint();
        }
        ...
        public static Proc_OK_Discharge_Magazine GetSingleton() => GetSingletonInstance(() => new Proc_OK_Discharge_Magazine("OK_Discharge_Magazine"));
        ...
        protected override bool ReadyToUnload()
        {
            ...
            return laneOK.m_enuAction == BaseLane.enuAction.Load_Waiting || laneOK.m_enuAction == BaseLane.enuAction.Loading;
        }
