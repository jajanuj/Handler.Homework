...
{
    public class Proc_NG_Feed_Magazine : BaseMagazine
    {
        #region Constructors

        #region ===================== 建構子 =====================

        public Proc_NG_Feed_Magazine(string p_strName) : base(p_strName)
        {
            BindHardwarePoint();
        }
        ...
        public static Proc_NG_Feed_Magazine GetSingleton() => GetSingletonInstance(() => new Proc_NG_Feed_Magazine("NG_Feed_Magazine"));
        ...
        {
            var laneNg = GetDownstreamLaneForBill();
            ...
            return laneNg.m_enuAction == BaseLane.enuAction.Load_Waiting || laneNg.m_enuAction == BaseLane.enuAction.Loading;
        }
        ...
        protected override BaseLane GetDownstreamLaneForBill() => Proc_NG_Lane.GetSingleton();
        ...
        {
            //DI
            m_DI_Magazine_Present = clsEnum.enuDi.NG_Feed_Mag_Present;
            m_DI_OverPress_B = clsEnum.enuDi.NG_Feed_Mag_Over_Press_B;
            m_DI_OutPush_Extend = clsEnum.enuDi.NG_Feed_Mag_Push_Fwd;
            m_DI_OutPush_Retract = clsEnum.enuDi.NG_Feed_Mag_Push_Bwd;

            //DO
            m_DO_OutPush_Extend = clsEnum.enuDo.NG_Feed_Mag_Stopper;

            //Motion
            m_Motor_Z = clsEnum.enuAxis.NG_Feed_Mag_Z;
        }
