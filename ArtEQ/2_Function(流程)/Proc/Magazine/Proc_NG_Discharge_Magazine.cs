...
{
    public class Proc_NG_Discharge_Magazine : BaseMagazine
    {
        #region Constructors

        #region ===================== 建構子 =====================

        public Proc_NG_Discharge_Magazine(string p_strName) : base(p_strName)
        {
            BindHardwarePoint();
        }
        ...
        public static Proc_NG_Discharge_Magazine GetSingleton() => GetSingletonInstance(() => new Proc_NG_Discharge_Magazine("NG_Discharge_Magazine"));
        ...
        {
            var ngLane = PreviousLane;
            if (ngLane == null)
                return false;

            return ngLane.m_enuAction == BaseLane.enuAction.Unload_Waiting_Sign;
        }

        /// <summary>
        /// 前一站的 Lane 是NGLane，因為 Magazine 是收料站。
        /// </summary>
        public override BaseLane PreviousLane => Proc_NG_Lane.GetSingleton();
        ...
        protected override void BindHardwarePoint()
        {
            ...
            //DI
            m_DI_Magazine_Present = clsEnum.enuDi.OK_Discharge_Mag_Present;

            //Motion
            m_Motor_Z = clsEnum.enuAxis.OK_Discharge_Mag_Z;
        }
