...
namespace ArtEQ._2_Function_流程_.BaseProc
{
    ...
    public abstract class BaseArm : clsThreadProc
    {
        ...
        private int m_iPickColumn;
        private int m_iPickRow;
        private int m_iPlaceColumn;
        ...
        /// Z軸安全位置
        /// </summary>
        protected double m_iSafePos_Z = ucPosPmt.GetValueDouble(enuPosName.SafePos_Z);
        ...
        protected override void Scenario()
        {
            switch (iStepIndex)
            {
                ...
                case 20100:
                    m_CtrlBox.Clear();
                    SetAddMotorZMoveAbsolute(m_iSafePos_Z);
                    iStepIndex = 20110;
                    break;
                ...
                case 30000:
                    ...
                    if (!AssyRecord.IsExist)
                    {
                        clsEditRunThread.ReportAlarm(enuAlarm.Place_Nozzle_No_Material);
                        iStepIndex = 30998;
                    }
                    else
                    {
                ...
                case 30400:
                    ...
                    //todo: 需要再處理站別轉點位
                    var placePosZ = ucPosPmt.GetValueDouble(enuPosName.PickPos_HSLane_Z);
                ...
                //馬達Z軸移動到安全位置
                case 30710:
                    m_CtrlBox.Action(ref iStepIndex, 30720, 30998);
                    Restart();
                    break;
