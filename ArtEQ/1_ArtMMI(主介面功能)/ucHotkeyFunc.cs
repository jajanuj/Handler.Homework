...
namespace ArtEQ
{
    public partial class ucHotkeyFunc : ucBaseUserControl
    {
        #region //=====================  區域變數設置 =====================
        ...
        static private ucHotkeyFunc m_Singleton;
        /// <summary> 取得唯一物件，避免重覆設置  </summary>
        static public ucHotkeyFunc GetSingleton()
        {
            if (m_Singleton == null)
            {
                m_Singleton = new ucHotkeyFunc();
            }
            return m_Singleton;
        }
        ...
        protected override void ReflashTimerFunc()
        {
            try
            {
                ...
                else if (ArtSystem.FormDesign.ucSubFunc._strNowMainFuncName == clsCmData.enuMainFunc.Operation.ToString())
                {
                    btnRun.Enabled = clsCmData.g_bIsinitialized == true;
