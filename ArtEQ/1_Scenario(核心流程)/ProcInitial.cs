...
namespace ArtEQ
{
    ...
    public class ProcInitial : clsThreadProc
    {
        ...
        protected override void Scenario() //tao autorun init
        {
            ...
            {
                case 0:
                    clsLog.Log(clsEnum.enuLogName.ProcessLog.ToString(), "========= Initial Start =========");
                ...
                case 9000:
                    #region//初始化完成
                    clsLog.Log(clsEnum.enuLogName.ProcessLog.ToString(), "========= Initial Finish =========");
                ...
                case -9000:
                    #region//初始化失敗
                    clsLog.Log(clsEnum.enuLogName.ProcessLog.ToString(), "========= Initial Fail =========");
